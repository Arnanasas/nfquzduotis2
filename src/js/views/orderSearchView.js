        ...
        <li">
            <a class="results__link" href="#${service.recipe_id}">
                ...
                <div class="results__data">
                    ...
                    <p class="results__author">Order placed for: ${limitServiceTitle(service.author)}</p>
                    <p class="results__description" style="display: none;">${service.description}</p>
                    <p class="results__date" style="display: none;">Order placed on: ${limitServiceTitle(service.date)}</p>
                </div>
            </a>
        </li>
    `;
...
export const renderSearchResult = (img, title, date, author, desc) => {
  ...
  const markup = `
    ...
    <div class="result__details">
        ...
        <div class="result__author result__date">
            <span class="result__info-text">${date}</span>
        </div>
